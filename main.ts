...
const contaCorrente2 = new ContaCorrente("0001", 1000);
const cliente2 = new Cliente("111.222.333-44", "João Silva", "77777-7777", true, [contaCorrente2]);
...
const cliente3 = new Cliente("111.222.333-44", "Jennifer Alves", "77777-7777", true, [contaCorrente3]);
...
const cliente41 = new Cliente("111.222.333-44", "João Silva", "77777-7777", true, [contaCorrente41]);
cliente41.adicionarConta(contaCorrente41);
contaCorrente41.depositar(1000);

const contaPoupanca42 = new ContaPoupanca("0002");
const cliente42 = new Cliente("111.222.333-44", "Lima Oscar", "77777-7777", true, [contaPoupanca42]);
...
const cliente51 = new Cliente("111.222.333-44", "João Silva", "77777-7777", true, [contaCorrente51]);
cliente51.adicionarConta(contaCorrente41);
contaCorrente51.depositar(300);

const contaCorrente52 = new ContaCorrente("0001", 100);
const cliente52 = new Cliente("111.222.333-44", "Luan Silva", "77777-7777", true, [contaCorrente52]);
